...
var browserDetect = (function () {
  ...
  if ((typeof window === "undefined" ? "undefined" : _typeof(window)) === 'object' && _typeof(window.device) === 'object') {
    delete window.device;
  }

  var classes = "".concat(document.documentElement.className).trim().split(/\s+/);
  ...
  var browserDetect = _objectSpread2({}, device, {
    ...
    chrome: function chrome() {
      return classes.indexOf('chrome') >= 0;
    },
    edge: function edge() {
      return classes.indexOf('edge') >= 0;
    },
    firefox: function firefox() {
      return classes.indexOf('firefox') >= 0;
    },
    gecko: function gecko() {
      return classes.indexOf('gecko') >= 0;
    },
    ie: function ie() {
      return classes.indexOf('ie') >= 0;
    },
    safari: function safari() {
      return classes.indexOf('safari') >= 0;
    },
    silk: function silk() {
      return classes.indexOf('silk') >= 0;
    },
    trident: function trident() {
      return classes.indexOf('trident') >= 0;
    },
    webkit: function webkit() {
      return classes.indexOf('webkit') >= 0;
    }
  });
